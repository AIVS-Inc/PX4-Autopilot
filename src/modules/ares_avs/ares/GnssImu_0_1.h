...
// Source file:   /home/ares/PX4-Autopilot/src/examples/ares_drone/ares/GnssImu.0.1.dsdl
// Generated at:  2024-02-22 21:58:29.411539 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef ARES_GNSS_IMU_0_1_INCLUDED_
#define ARES_GNSS_IMU_0_1_INCLUDED_
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/ares/PX4-Autopilot/src/examples/ares_drone/ares/GnssImu.0.1.dsdl is trying to use a serialization library that was compiled with "
...
#define ares_GnssImu_0_1_HAS_FIXED_PORT_ID_ false

#define ares_GnssImu_0_1_FULL_NAME_             "ares.GnssImu"
#define ares_GnssImu_0_1_FULL_NAME_AND_VERSION_ "ares.GnssImu.0.1"
...
#define ares_GnssImu_0_1_EXTENT_BYTES_                    55UL
#define ares_GnssImu_0_1_SERIALIZATION_BUFFER_SIZE_BYTES_ 55UL
static_assert(ares_GnssImu_0_1_EXTENT_BYTES_ >= ares_GnssImu_0_1_SERIALIZATION_BUFFER_SIZE_BYTES_,
              "Internal constraint violation");

typedef struct
{
    /// uavcan.time.SynchronizedTimestamp.1.0 m_u64UtcMicrosecond
    uavcan_time_SynchronizedTimestamp_1_0 m_u64UtcMicrosecond;
...
///                 @see ares_GnssImu_0_1_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t ares_GnssImu_0_1_serialize_(
    const ares_GnssImu_0_1* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // uavcan.time.SynchronizedTimestamp.1.0 m_u64UtcMicrosecond
        ...
        int8_t _err0_ = uavcan_time_SynchronizedTimestamp_1_0_serialize_(
            &obj->m_u64UtcMicrosecond, &buffer[offset_bits / 8U], &_size_bytes0_);
        if (_err0_ < 0)
        {
            return _err0_;
        }
    ...
    {   // reg.udral.physics.kinematics.geodetic.Point.0.1 m_glGnssLlh
        ...
        int8_t _err3_ = reg_udral_physics_kinematics_geodetic_Point_0_1_serialize_(
            &obj->m_glGnssLlh, &buffer[offset_bits / 8U], &_size_bytes1_);
        if (_err3_ < 0)
        {
            return _err3_;
        }
    ...
    {   // uavcan.si.unit.length.Scalar.1.0 m_fHorizontalAccuracy
        ...
        int8_t _err5_ = uavcan_si_unit_length_Scalar_1_0_serialize_(
            &obj->m_fHorizontalAccuracy, &buffer[offset_bits / 8U], &_size_bytes2_);
        if (_err5_ < 0)
        {
            return _err5_;
        }
    ...
    {   // uavcan.si.unit.length.Scalar.1.0 m_fVerticalAccuracy
        ...
        int8_t _err7_ = uavcan_si_unit_length_Scalar_1_0_serialize_(
            &obj->m_fVerticalAccuracy, &buffer[offset_bits / 8U], &_size_bytes3_);
        if (_err7_ < 0)
        {
            return _err7_;
        }
    ...
    {   // uavcan.si.unit.angle.Scalar.1.0 m_fPitch
        ...
        int8_t _err9_ = uavcan_si_unit_angle_Scalar_1_0_serialize_(
            &obj->m_fPitch, &buffer[offset_bits / 8U], &_size_bytes4_);
        if (_err9_ < 0)
        {
            return _err9_;
        }
    ...
    {   // uavcan.si.unit.angle.Scalar.1.0 m_fRoll
        ...
        int8_t _err11_ = uavcan_si_unit_angle_Scalar_1_0_serialize_(
            &obj->m_fRoll, &buffer[offset_bits / 8U], &_size_bytes5_);
        if (_err11_ < 0)
        {
            return _err11_;
        }
    ...
    {   // uavcan.si.unit.angle.Scalar.1.0 m_fYaw
        ...
        int8_t _err13_ = uavcan_si_unit_angle_Scalar_1_0_serialize_(
            &obj->m_fYaw, &buffer[offset_bits / 8U], &_size_bytes6_);
        if (_err13_ < 0)
        {
            return _err13_;
        }
...
///
/// @returns Negative on error, zero on success.
static inline int8_t ares_GnssImu_0_1_deserialize_(
    ares_GnssImu_0_1* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // uavcan.time.SynchronizedTimestamp.1.0 m_u64UtcMicrosecond
    {
        ...
        const int8_t _err15_ = uavcan_time_SynchronizedTimestamp_1_0_deserialize_(
            &out_obj->m_u64UtcMicrosecond, &buffer[offset_bits / 8U], &_size_bytes7_);
        if (_err15_ < 0)
        {
            return _err15_;
        }
    ...
    // reg.udral.physics.kinematics.geodetic.Point.0.1 m_glGnssLlh
    {
        ...
        const int8_t _err16_ = reg_udral_physics_kinematics_geodetic_Point_0_1_deserialize_(
            &out_obj->m_glGnssLlh, &buffer[offset_bits / 8U], &_size_bytes8_);
        if (_err16_ < 0)
        {
            return _err16_;
        }
    ...
    // uavcan.si.unit.length.Scalar.1.0 m_fHorizontalAccuracy
    {
        ...
        const int8_t _err17_ = uavcan_si_unit_length_Scalar_1_0_deserialize_(
            &out_obj->m_fHorizontalAccuracy, &buffer[offset_bits / 8U], &_size_bytes9_);
        if (_err17_ < 0)
        {
            return _err17_;
        }
    ...
    // uavcan.si.unit.length.Scalar.1.0 m_fVerticalAccuracy
    {
        ...
        const int8_t _err18_ = uavcan_si_unit_length_Scalar_1_0_deserialize_(
            &out_obj->m_fVerticalAccuracy, &buffer[offset_bits / 8U], &_size_bytes10_);
        if (_err18_ < 0)
        {
            return _err18_;
        }
    ...
    // uavcan.si.unit.angle.Scalar.1.0 m_fPitch
    {
        ...
        const int8_t _err19_ = uavcan_si_unit_angle_Scalar_1_0_deserialize_(
            &out_obj->m_fPitch, &buffer[offset_bits / 8U], &_size_bytes11_);
        if (_err19_ < 0)
        {
            return _err19_;
        }
    ...
    // uavcan.si.unit.angle.Scalar.1.0 m_fRoll
    {
        ...
        const int8_t _err20_ = uavcan_si_unit_angle_Scalar_1_0_deserialize_(
            &out_obj->m_fRoll, &buffer[offset_bits / 8U], &_size_bytes12_);
        if (_err20_ < 0)
        {
            return _err20_;
        }
    ...
    // uavcan.si.unit.angle.Scalar.1.0 m_fYaw
    {
        ...
        const int8_t _err21_ = uavcan_si_unit_angle_Scalar_1_0_deserialize_(
            &out_obj->m_fYaw, &buffer[offset_bits / 8U], &_size_bytes13_);
        if (_err21_ < 0)
        {
            return _err21_;
        }
...
static inline void ares_GnssImu_0_1_initialize_(ares_GnssImu_0_1* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = ares_GnssImu_0_1_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // ARES_GNSS_IMU_0_1_INCLUDED_
