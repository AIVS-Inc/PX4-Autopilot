...
// Source file:   /home/ares/PX4-Autopilot/src/examples/ares_drone/ares/EventParams.0.1.dsdl
// Generated at:  2024-02-22 21:58:29.405626 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/ares/PX4-Autopilot/src/examples/ares_drone/ares/EventParams.0.1.dsdl is trying to use a serialization library that was compiled with "
    ...
    const ares_EventParams_0_1* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated uint16 m_paramId
        ...
        const int8_t _err0_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, obj->m_paramId, 16U);
        if (_err0_ < 0)
        {
            return _err0_;
        }
    ...
    ares_EventParams_0_1* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // saturated uint16 m_paramId
    out_obj->m_paramId = nunavutGetU16(&buffer[0], capacity_bytes, offset_bits, 16);
    offset_bits += 16U;
