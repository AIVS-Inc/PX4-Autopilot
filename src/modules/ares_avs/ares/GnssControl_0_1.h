...
// Generated at:  2024-04-15 19:21:31.884027 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef ARES_GNSS_CONTROL_0_1_INCLUDED_
#define ARES_GNSS_CONTROL_0_1_INCLUDED_
...
#define ares_GnssControl_0_1_HAS_FIXED_PORT_ID_ false

#define ares_GnssControl_0_1_FULL_NAME_             "ares.GnssControl"
#define ares_GnssControl_0_1_FULL_NAME_AND_VERSION_ "ares.GnssControl.0.1"
...
///                 @see ares_GnssControl_0_1_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t ares_GnssControl_0_1_serialize_(
    const ares_GnssControl_0_1* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated uint16 m_u16ParamId
        ...
        const int8_t _err0_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, obj->m_u16ParamId, 16U);
        if (_err0_ < 0)
        {
            return _err0_;
        }
...
///
/// @returns Negative on error, zero on success.
static inline int8_t ares_GnssControl_0_1_deserialize_(
    ares_GnssControl_0_1* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // saturated uint16 m_u16ParamId
    out_obj->m_u16ParamId = nunavutGetU16(&buffer[0], capacity_bytes, offset_bits, 16);
    offset_bits += 16U;
...
static inline void ares_GnssControl_0_1_initialize_(ares_GnssControl_0_1* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = ares_GnssControl_0_1_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // ARES_GNSS_CONTROL_0_1_INCLUDED_
