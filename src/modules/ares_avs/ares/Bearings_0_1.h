...
// Source file:   /home/ares/PX4-Autopilot/src/examples/ares_drone/ares/Bearings.0.1.dsdl
// Generated at:  2024-02-22 21:58:29.399797 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef ARES_BEARINGS_0_1_INCLUDED_
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/ares/PX4-Autopilot/src/examples/ares_drone/ares/Bearings.0.1.dsdl is trying to use a serialization library that was compiled with "
...
#define ares_Bearings_0_1_HAS_FIXED_PORT_ID_ false

#define ares_Bearings_0_1_FULL_NAME_             "ares.Bearings"
#define ares_Bearings_0_1_FULL_NAME_AND_VERSION_ "ares.Bearings.0.1"
...
///                 @see ares_Bearings_0_1_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t ares_Bearings_0_1_serialize_(
    const ares_Bearings_0_1* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated uint32 m_iSourceIndex
        // Saturation code not emitted -- native representation matches the serialized representation.
        const int8_t _err2_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, obj->m_iSourceIndex, 32U);
        if (_err2_ < 0)
        {
            return _err2_;
        }
...
///
/// @returns Negative on error, zero on success.
static inline int8_t ares_Bearings_0_1_deserialize_(
    ares_Bearings_0_1* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // saturated uint32 m_iSourceIndex
    out_obj->m_iSourceIndex = nunavutGetU32(&buffer[0], capacity_bytes, offset_bits, 32);
    offset_bits += 32U;
    ...
    // saturated float32 m_fAzimuth
    out_obj->m_fAzimuth = nunavutGetF32(&buffer[0], capacity_bytes, offset_bits);
    offset_bits += 32U;
    ...
    // saturated float32 m_fElevation
    out_obj->m_fElevation = nunavutGetF32(&buffer[0], capacity_bytes, offset_bits);
    offset_bits += 32U;
...
static inline void ares_Bearings_0_1_initialize_(ares_Bearings_0_1* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = ares_Bearings_0_1_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // ARES_BEARINGS_0_1_INCLUDED_
