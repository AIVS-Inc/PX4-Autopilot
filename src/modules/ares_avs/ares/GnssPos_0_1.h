...
// Generated at:  2024-03-29 00:35:07.483726 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef ARES_GNSS_POS_0_1_INCLUDED_
#define ARES_GNSS_POS_0_1_INCLUDED_
...
#define ares_GnssPos_0_1_HAS_FIXED_PORT_ID_ false

#define ares_GnssPos_0_1_FULL_NAME_             "ares.GnssPos"
#define ares_GnssPos_0_1_FULL_NAME_AND_VERSION_ "ares.GnssPos.0.1"
...
#define ares_GnssPos_0_1_EXTENT_BYTES_                    55UL
#define ares_GnssPos_0_1_SERIALIZATION_BUFFER_SIZE_BYTES_ 55UL
...
///                 @see ares_GnssPos_0_1_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t ares_GnssPos_0_1_serialize_(
    const ares_GnssPos_0_1* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated float32 m_fGroundSpeed
        // Saturation code not emitted -- assume the native representation of float32 is conformant.
        static_assert(NUNAVUT_PLATFORM_IEEE754_FLOAT, "Native IEEE754 binary32 required. TODO: relax constraint");
        const int8_t _err5_ = nunavutSetF32(&buffer[0], capacity_bytes, offset_bits, obj->m_fGroundSpeed);
        if (_err5_ < 0)
        {
            return _err5_;
        }
    ...
    {   // saturated float32 m_fAltitudeEllipsoid
        // Saturation code not emitted -- assume the native representation of float32 is conformant.
        static_assert(NUNAVUT_PLATFORM_IEEE754_FLOAT, "Native IEEE754 binary32 required. TODO: relax constraint");
        const int8_t _err6_ = nunavutSetF32(&buffer[0], capacity_bytes, offset_bits, obj->m_fAltitudeEllipsoid);
        if (_err6_ < 0)
        {
            return _err6_;
        }
    ...
    {   // saturated float32 m_fNorthVel
        // Saturation code not emitted -- assume the native representation of float32 is conformant.
        static_assert(NUNAVUT_PLATFORM_IEEE754_FLOAT, "Native IEEE754 binary32 required. TODO: relax constraint");
        const int8_t _err7_ = nunavutSetF32(&buffer[0], capacity_bytes, offset_bits, obj->m_fNorthVel);
        if (_err7_ < 0)
        {
            return _err7_;
        }
    ...
    {   // saturated float32 m_fEastVel
        // Saturation code not emitted -- assume the native representation of float32 is conformant.
        static_assert(NUNAVUT_PLATFORM_IEEE754_FLOAT, "Native IEEE754 binary32 required. TODO: relax constraint");
        const int8_t _err8_ = nunavutSetF32(&buffer[0], capacity_bytes, offset_bits, obj->m_fEastVel);
        if (_err8_ < 0)
        {
            return _err8_;
        }
    ...
    {   // saturated float32 m_fDownVel
        // Saturation code not emitted -- assume the native representation of float32 is conformant.
        static_assert(NUNAVUT_PLATFORM_IEEE754_FLOAT, "Native IEEE754 binary32 required. TODO: relax constraint");
        const int8_t _err9_ = nunavutSetF32(&buffer[0], capacity_bytes, offset_bits, obj->m_fDownVel);
        if (_err9_ < 0)
        {
            return _err9_;
        }
    ...
    {   // saturated uint8 m_u8PDOP
        // Saturation code not emitted -- native representation matches the serialized representation.
        buffer[offset_bits / 8U] = (uint8_t)(obj->m_u8PDOP);  // C std, 6.3.1.3 Signed and unsigned integers
        offset_bits += 8U;
    }
    ...
    if (offset_bits % 8U != 0U)  // Pad to 8 bits. TODO: Eliminate redundant padding checks.
    {
        ...
        const int8_t _err10_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, 0U, _pad0_);  // Optimize?
        if (_err10_ < 0)
        {
            return _err10_;
        }
...
///
/// @returns Negative on error, zero on success.
static inline int8_t ares_GnssPos_0_1_deserialize_(
    ares_GnssPos_0_1* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // saturated float64 m_dLongitude
    out_obj->m_dLongitude = nunavutGetF64(&buffer[0], capacity_bytes, offset_bits);
    offset_bits += 64U;
    ...
    {
        out_obj->m_u8PDOP = buffer[offset_bits / 8U] & 255U;
    }
    else
    {
        out_obj->m_u8PDOP = 0U;
...
static inline void ares_GnssPos_0_1_initialize_(ares_GnssPos_0_1* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = ares_GnssPos_0_1_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // ARES_GNSS_POS_0_1_INCLUDED_
